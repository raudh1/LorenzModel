...
def dir_network(filename, plot_dir="plots", logfile="trainlog.txt", lyapfile="lyapunovs.txt", lossfile = "loss_epoch.txt"):
    path_dir = filename
    ...
    file_lyap.close()
    file_lossepoch = open("./"+filename+"/"+lossfile, "w")
    file_lossepoch.close()
